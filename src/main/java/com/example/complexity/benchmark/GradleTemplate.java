...
public class GradleTemplate {
  ...
  static final String BENCHMARKRUNNER_FILENAME = "src/jmh/java/org/example/BenchmarkRunner.java";

  static final String MAIN_FILENAME = "src/main/java/org/example/Main.java";
  ...
  private static final String BenchmarkRunnerContent = """
      package org.example;
      ...
      """;
  private static final String buildGradleContent = """
            plugins {
                id 'java'
            ...
            jmh {
                resultFormat = 'JSON'
                humanOutputFile = project.file("${project.buildDir}/results/jmh/human.txt")
      ...
      """;
  private static final String gradlewContent = """
      #!/bin/sh
      ...
      exec "$JAVACMD" "$@"
      """;
  private File buildGradleFilepath;
  private File gradlewFilepath;
  ...
  private void composeFilepaths(File parent) {
    buildGradleFilepath = new File(parent, BUILDGRADLE_FILENAME);
    gradlewFilepath = new File(parent, GRADLEW_FILENAME);
    MainFilepath = new File(parent, MAIN_FILENAME);
  ...
  private void write() throws GradleTemplateWriteFailure {
    ...
    write(BenchmarkRunnerFilepath, BenchmarkRunnerContent);
  }
}
